package com.nikolastojiljkovic.quill.mysql

import com.nikolastojiljkovic.quill.PageSqlSpec
import com.nikolastojiljkovic.quill.model.{ Page, SampleTraitWithNestable, SeoSupport }

import scala.concurrent.{ Await, Future }
import scala.concurrent.duration.Duration
import scala.concurrent.ExecutionContext.Implicits.{ global => ec }

class PageMysqlAsyncSpec extends PageSqlSpec {
